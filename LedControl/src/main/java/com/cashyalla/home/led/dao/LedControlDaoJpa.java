...
public class LedControlDaoJpa implements LedControlDao {
	...
	@Override
	public void saveCurrentLedMode(CurrentLedMode currentLedMode) {
		currentLedModeRepository.save(currentLedMode);
	}

	@Override
	public void removeCurrentLedMode() {
		currentLedModeRepository.deleteAll();
		currentLedModeRepository.flush();
	}
